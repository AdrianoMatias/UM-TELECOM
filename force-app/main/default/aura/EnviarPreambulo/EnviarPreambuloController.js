({
	doInit: function (component, event, helper) {
		helper.inicializaLista(component);
	},

	enviaPreambulo: function (component, event, helper) {
		helper.enviarPreambuloHlp(component);
	},
	...
	enviarPreambuloContato : function (component, event, helper) {
		helper.enviarPreambuloHlp(component);
	}
})